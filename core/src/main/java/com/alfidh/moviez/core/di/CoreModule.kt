package com.alfidh.moviez.core.di

import androidx.room.Room
import com.alfidh.moviez.core.data.MovieRepository
import com.alfidh.moviez.core.data.source.local.LocalDataSource
import com.alfidh.moviez.core.data.source.local.room.MovieDatabase
...
val databaseModule = module {
    ...
    single {
        ...
        Room.databaseBuilder(
            androidContext(),
            MovieDatabase::class.java, "Moviez.db"
